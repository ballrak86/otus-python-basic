...
async def job_create(title=Form(default = None), description=Form(default = None), due_date=Form(default = None), completed: bool=Form(default = False)):
...
async def job_update(id_item: int, title=Form(default = None), description=Form(default = None), due_date=Form(default = None), completed: bool=Form(default = False)):
    """Обновить задачу"""
